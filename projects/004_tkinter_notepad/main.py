...
class SimpleNotepad:
    ...
    def __init__(self, root: Tk) -> None:
        ...
        # Create and pack the new button
    ...
    def save_file(self) -> None:
        ...
        if self.file_path != '' :
            ...
            self.new_file()
            print(f'new File crated at: {self.file_path}')


    # 5. Create a function that loads files
    def load_file(self) -> None:
        self.file_path: str = filedialog.askopenfilename(defaultextension='.txt',
    ...
    def new_file(self) ->None :
        ...
        self.file_path = filedialog.asksaveasfilename(title = 'New File',defaultextension='.txt',
                                                    filetypes=[('Text files', '*.txt')])
        print(f'new File crated at: {self.file_path}')
